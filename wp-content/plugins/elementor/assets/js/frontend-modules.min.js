  ...
  [354],
  {
    ...
    6412: (e, t, n) => {
      ...
      r.default.frontend = {
        ...
        handlers: {
          ...
          NestedTitleKeyboardHandler: m.default,
          ContactButtonsHandler: g.default,
        },
      };
    },
    5658: (e) => {
      ...
      class ContactButtonsHandler extends r.default {
        ...
        removeAnimationClasses() {
          const {
            ...
            s = this.elements.content.classList.contains(e),
          ...
          s
            ? (this.elements.content.classList.remove(i),
              ...
              this.elements.content.classList.remove(a),
              this.elements.content.classList.remove(r))
            : (this.elements.content.classList.remove(i),
              this.elements.content.classList.remove(o),
        ...
        openChatBox() {
          ...
          this.elements.main.classList.contains(e)
        ...
        closeChatBox() {
          ...
          this.elements.main.classList.contains(e)
            ...
            this.elements.contentWrapper.classList.add(n);
        }
        onChatButtonClick() {
          const { hidden: e } = this.getSettings("constants");
          this.elements.contentWrapper.classList.contains(e)
            ? this.openChatBox()
            : this.closeChatBox();
        }
        initMessageBubbleTime() {
          ...
          this.elements.messageBubbleTime.innerHTML = t;
        }
        initChatButtonEntranceAnimation() {
          const {
            ...
            i = this.getResponsiveSetting(t);
          e !== i &&
            (this.elements.chatButton.classList.add(n),
            this.elements.chatButton.classList.add(i));
        }
        onInit() {
          super.onInit(...arguments),
    ...
    1695: (e, t, n) => {
      ...
      e.exports = function (e, t) {
        var n,
          ...
          p = e.global,
          f = e.stat;
        if ((n = p ? i : f ? i[m] || a(m, {}) : (i[m] || {}).prototype))
          for (u in t) {
            if (
              ((h = t[u]),
              (d = e.dontCallGetSet ? (g = r(n, u)) && g.value : n[u]),
              !c(p ? u : m + (f ? "." : "#") + u, e.forced) && void 0 !== d)
            ) {
      ...
      var i = n(8240),
        ...
        S = (e.exports = function (e, t, n) {
          "Symbol(" === p(g(t), 0, 7) &&
            ...
            n && n.setter && (t = "set " + t),
            (!o(e, "name") || (l && e.name !== t)) &&
              (a ? m(e, "name", { value: t, configurable: !0 }) : (e.name = t)),
            b &&
              n &&
              o(n, "arity") &&
              e.length !== n.arity &&
    ...
    1557: (e, t, n) => {
      ...
      e.exports = function (e, t, n, f) {
        ...
        if (w) {
          var E = w.prototype;
          if ((!p && r(E, "cause") && delete E.cause, !n)) return w;
          var T = i("Error"),
            C = t(function (e, t) {
          ...
          if (
            ...
            "Error" !== S
              ? a
                ? a(C, T)
                : l(C, T, { name: !0 })
              : m && v in w && (c(C, w, v), c(C, w, "prepareStackTrace")),
            l(C, w),
            !p)
          )
            try {
