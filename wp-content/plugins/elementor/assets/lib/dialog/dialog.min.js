  ...
  (y.Instance = function () {
    ...
    (y.Widget = function (n) {
      function e(t, e) {
        var t = a.effects[t],
          n = d.widget;
        if ("function" == typeof t) t.apply(n, e);
        else {
      ...
      function o(t) {
        f(t) || p(t.target).closest(d.widget).length || h(t) || c.hide();
      }
      function s(t, e) {
        (t = p.extend(!0, {}, t.getSettings())),
          ...
          p.extend(!0, a, c.getDefaultSettings(), e),
          p.each(a, function (t) {
            t = t.match(/^on([A-Z].*)/);
            t &&
      ...
      function t() {
        ...
        d.iframe && t.push(jQuery(d.iframe[0].contentWindow)),
          t.forEach(function (t) {
            a.hide.onEscKeyPress && t.off("keyup", r),
              a.hide.onOutsideClick && t[0].removeEventListener("click", o, !0),
              a.hide.onOutsideContextMenu &&
                t[0].removeEventListener("contextmenu", o, !0),
              a.position.autoRefresh && t.off("resize", c.refreshPosition);
          }),
      ...
      (this.addElement = function (t, e, n) {
        ...
        (this.hide = function () {
          if (c.isVisible())
            return (
              ...
              t(),
              a.preventScroll &&
                c.getElements("body").removeClass(a.classes.preventScroll),
              c.trigger("hide"),
              c
            );
        }),
        (this.init = function (t, e) {
          ...
          if (t instanceof y.Instance)
            return (
              (n = g.concat(c.getClosureMethods())),
              p.each(n, function () {
                var t = c[this];
                c[this] = function () {
                  t.apply(c, arguments);
              ...
              c.addElement("container", a.container),
              a.iframe && c.addElement("iframe", a.iframe),
              a.closeButton &&
                (a.closeButtonClass &&
                  (a.closeButtonOptions.iconClass = a.closeButtonClass),
                (n = p("<a>", a.closeButtonOptions.attributes)),
                (i = p(a.closeButtonOptions.iconElement).addClass(
                  a.closeButtonOptions.iconClass
                )),
                n.append(i),
                c.addElement("closeButton", n)),
              (i = c.getSettings("id")) && c.setID(i),
              (o = []),
              p.each(c.types, function () {
                o.push(a.classes.globalPrefix + "-type-" + this);
              }),
              o.push(c.getSettings("className")),
              d.widget
                .addClass(o.join(" "))
        ...
        (this.off = function (t, e) {
          return (
            u[t] &&
              (e
                ? -1 !== (e = u[t].indexOf(e)) && u[t].splice(e, 1)
                : delete u[t]),
            c
          );
        }),
        ...
        (this.setSettings = function (t, e) {
          return (
            jQuery.isPlainObject(e) ? p.extend(!0, a[t], e) : (a[t] = e), c
          );
        }),
        (this.show = function () {
          var t;
          return (
            ...
            e("show", arguments),
            c.refreshPosition(),
            a.hide.auto && (l = setTimeout(c.hide, a.hide.autoDelay)),
            (t = [d.window]),
            d.iframe && t.push(jQuery(d.iframe[0].contentWindow)),
            t.forEach(function (t) {
              a.hide.onEscKeyPress && t.on("keyup", r),
                a.hide.onOutsideClick && t[0].addEventListener("click", o, !0),
                a.hide.onOutsideContextMenu &&
                  t[0].addEventListener("contextmenu", o, !0),
                a.position.autoRefresh && t.on("resize", c.refreshPosition);
            }),
            (a.hide.onClick || a.hide.onBackgroundClick) &&
              d.widget.on("click", i),
            a.preventScroll &&
              c.getElements("body").addClass(a.classes.preventScroll),
            c.trigger("show"),
            c
          );
        }),
    ...
    (y.Widget.prototype.attachEvents = function () {
      var e = this;
      e.getSettings("closeButton") &&
        e.getElements("closeButton").on("click", function (t) {
    ...
    y.addWidgetType("buttons", {
      ...
      activeKeyDown: function (t) {
        ...
        this.focusedButton &&
          ...
          (this.focusedButton = this.buttons[n].trigger("focus")));
      },
      addButton: function (t) {
        function e() {
          i.hide.onButtonClick && n.hide(),
            "function" == typeof t.callback && t.callback.call(this, n);
        }
        var n = this,
          i = n.getSettings(),
          ...
          o =
            ...
            n.addElement(t.name, p("<" + o.tag + ">").html(t.text), s));
        n.buttons.push(o);
        return (
          o.on("click", e),
          t.hotKey && (this.hotKeys[t.hotKey] = e),
          this.getElements("buttonsWrapper").append(o),
          t.focus && (this.focusedButton = o),
          n
        );
      },
