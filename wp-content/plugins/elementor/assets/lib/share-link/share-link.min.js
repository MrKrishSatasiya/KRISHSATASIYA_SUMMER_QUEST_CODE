!(function (t) {
  (window.ShareLink = function (e, r) {
    ...
    (ShareLink.networkTemplates = {
      twitter: "https://x.com/Krish_Satasiyaintent/tweet?text={text} {url}",
      "x-twitter": "https://x.com/intent/tweet?text={text} {url}",
      pinterest:
        "https://www.pinterest.com/pin/create/button/?url={url}&media={image}",
      facebook: "https://www.facebook.com/krish.satasiya.5811sharer.php?u={url}",
      threads: "https://threads.net/intent/post?text={text} {url}",
      vk: "https://vkontakte.ru/share.php?url={url}&title={title}&description={text}&image={image}",
      linkedin:
        "https://www.linkedin.com/in/mrkrishsatasiya/shareArticle?mini=true&url={url}&title={title}&summary={text}&source={url}",
      odnoklassniki:
