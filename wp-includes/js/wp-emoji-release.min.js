          ...
          ("string" == typeof d
            ...
            : function (d, u) {
                      ...
                      (c = b[a]),
                        3 === (e = c.nodeType)
                          ...
                          : 1 !== e ||
                            ...
                            m.test(c.nodeName.toLowerCase()) ||
                            (h.doNotParse && h.doNotParse(c)) ||
                            d(c, f);
                    return f;
                  })(d, []),
                  p = l.length;
                for (; p--; ) {
                  ...
                  e &&
                    (r < t.length && b.appendChild(x(t.slice(r), !0)),
      ...
      function s() {
        if (!t) {
          if (void 0 === c.twemoji)
            return 600 < r
              ? void 0
              : (c.clearTimeout(u), (u = c.setTimeout(s, 50)), void r++);
          (n = c.twemoji),
            (t = !0),
            e &&
              new e(function (u) {
            ...
            (t = {
              ...
              doNotParse: function (u) {
                return !(
                  ...
                  -1 === u.className.indexOf("wp-exclude-emoji")
                );
              },
            }),
